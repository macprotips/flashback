...
| FreeJ2ME at fae9304b | Bundled GPLv3 Java ME/MIDP player, built from the pinned source with Flashback's title/readiness patch. Its ObjectWeb ASM notices and complete source accompany the app. |
